...
contextBridge.exposeInMainWorld("openexam", {
  ...
  db: {
    ...
    getPracticeRecords: (options) => ipcRenderer.invoke("db:getPracticeRecords", options),
    ...
    getCategoryStats: (options) => ipcRenderer.invoke("db:getCategoryStats", options),
    getSubCategoryStats: (category, options) => ipcRenderer.invoke("db:getSubCategoryStats", { category, options }),
    getPracticeStats: (options) => ipcRenderer.invoke("db:getPracticeStats", options),
    ...
    getSavedAIPapers: (options) => ipcRenderer.invoke("db:getSavedAIPapers", options),
    ...
    getDailyStats: (days, options) => ipcRenderer.invoke("db:getDailyStats", { days, options }),
    getStreakDays: (options) => ipcRenderer.invoke("db:getStreakDays", options),
    getTodayStats: (options) => ipcRenderer.invoke("db:getTodayStats", options),
    getHeatmapData: (days, options) => ipcRenderer.invoke("db:getHeatmapData", { days, options }),
    getGrowthData: (options) => ipcRenderer.invoke("db:getGrowthData", options),
